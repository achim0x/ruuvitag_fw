...
#include <stdbool.h>
#include "boards.h"
#include "bsp_board_config.h" //Check the #ifndef-endif groupings if you override defaults
...
#ifndef BSP_LED_INDICATE_SENT_OK  
...
#ifndef BSP_LED_INDICATE_USER_LED1 
